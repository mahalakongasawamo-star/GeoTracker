  ...
  return (
    <Floating sensitivity={2.2} easingFactor={0.05}>
      ...
      <div className="relative z-[1] mx-auto flex min-h-screen w-full max-w-[1480px] flex-col px-14 max-[1100px]:px-8 max-[720px]:px-5">
        {/* Header */}
        <header className="flex flex-shrink-0 items-center justify-between py-[22px] max-[720px]:py-4">
        ...
        >
          ...
          <div className="max-w-[620px]">
            <div className="mb-[26px] inline-flex items-center gap-2.5 rounded-full border border-line-strong bg-bg-3 px-3.5 py-1.5 font-mono text-[11px] uppercase tracking-[0.1em] text-ink-2 max-[720px]:mb-[18px] max-[720px]:px-3 max-[720px]:py-[5px] max-[720px]:text-[10px]">
              <span className="block h-1.5 w-1.5 flex-shrink-0 animate-eyebrow-pulse rounded-full bg-coral" />
              Live in 12 seconds · No signup
            </div>

            <h1 className="mb-[22px] text-[clamp(34px,4.8vw,68px)] font-bold leading-[0.98] tracking-[-0.035em] text-ink max-[720px]:mb-4 max-[720px]:leading-[1.02]">
              Is your business
              <br />
              <span className="font-serif italic font-normal text-coral">invisible</span> to AI?
            </h1>

            <p className="mb-[30px] max-w-[540px] text-[18px] leading-[1.55] text-ink-2 max-[720px]:mb-[22px] max-[720px]:text-[16px] max-[720px]:leading-[1.5]">
            ...
            <div className="mt-[26px] flex flex-wrap gap-5 font-mono text-[11px] uppercase tracking-[0.08em] text-ink-2 max-[720px]:mt-5 max-[720px]:gap-3.5 max-[720px]:text-[10px]">
        ...
        {/* Footer strip */}
        <div className="flex flex-shrink-0 flex-wrap items-center justify-between gap-2 border-t border-line py-[14px] pb-[18px] font-mono text-[11px] uppercase tracking-[0.08em] text-ink-3 max-[720px]:py-3 max-[720px]:pb-4 max-[720px]:text-[10px]">
          <div>
